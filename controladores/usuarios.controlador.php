		...
		if (isset($_POST["regUsuario"])) {
			...
			if (
				...
				if ($respuesta == "ok") {
					...
					$mail->CharSet = 'UTF-8';
					$mail->isMail();
					$mail->setFrom('Romajeansof@gmail.com', 'Roma Jeans');
					$mail->addReplyTo('Romajeansof@gmail.com', 'Roma Jeans');
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				$servidor = Ruta::ctrRutaServidor();
					...
					$mail->setFrom('Romajeansof@gmail.com', 'Roma Jean');

					$mail->addReplyTo('Romajeansof@gmail.com', 'Roma Jean');
					...
					$mail->msgHTML('
						...
						<center><img style="padding:20px; width:10%" src="' . $servidor . 'vistas/img/plantilla/email.png"></center>

						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">

							<center>

							<img style="padding-top:20px; width:15%" src="' . $servidor . 'vistas/img/plantilla/email.png">

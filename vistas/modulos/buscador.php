                                ...
                                echo'<h2><small>GRATIS</small></h2> <br><br>';
                                    ...
                                    if ($value["oferta"]!=0) {
                                        echo'<h2><small>
                                             ...
                                             <small style="color:green ;font-size:26px;">  S/.'.$value["precioOferta"].' SOL</small><br> 
                                             ';
                                    }else{
				        	...
				        	if($pagProductos > 4){
				        		...
				        		=============================================*/
				        				...
				        				for($i = $numPagActual; $i <= ($numPagActual+3); $i ++){
				        					...
				        					echo '<li id="item'.$i.'"><a href="'.$url.$rutas[0].'/'.$i.'/'.$rutas[2].'/'.$rutas[3].'/'.$rutas[2].'/'.$rutas[3].'">'.$i.'</a></li>';
				        		...
				        		=============================================*/
				        				...
				        				for($i = $numPagActual; $i <= ($numPagActual+3); $i ++){
				        					...
				        					echo '<li id="item'.$i.'"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'/'.$rutas[2].'/'.$rutas[3].'</a></li>';

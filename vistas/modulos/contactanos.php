...
<section class="w3l-banner-slider-main inner-pagehny">
        <div class="breadcrumb-infhny" style="background-color:#0d1117;padding-top:0px;padding-bottom:0px;border:none;top:-30px;margin-bottom:0px;font-size:25px;margin-bottom:30px">

            <div class="top-header-content"style="background-color:#0d1117;padding-top:0px;padding-bottom:0px;border:none;top:-30px;margin-bottom:0px;font-size:25px;">


                <div class="breadcrumb-contentnhy"style="background-color:#0d1117;padding-top:0px;padding-bottom:0px;border:none;top:-30px;margin-bottom:0px;font-size:25px;">
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <h2 class="hny-title text-center">Contactanos </h2>
                            <ol class="breadcrumb mb-0" style="background-color:#0d1117;padding-top:0px;padding-bottom:0px;border:none;top:-30px;margin-bottom:0px;font-size:25px;">
            ...
            <div class="container py-lg-5">
                <div class="welcome-grids row">
                    ...
                    <div class="col-lg-6 welcome-image">
                        <img src="<?php echo $servidor?>vistas/img/ofertas/Ropa-para-dama.jpg" class="img-fluid" alt="Imagenes de contactanos" style="height: 350px;"/>
                    ...
                    <div class="col-lg-7 story-gd pl-lg-4">
                        ...
                        <div class="row story-info-content mt-md-5 mt-4">
                            ...
                            <div class="col-md-6 story-info">
                                <h5> 01. Visit Store</h5>
                                <p>Lorem illum facere aperiam sequi optio consectetur adipisicing elitFuga, suscipit totam animi consequatur.
                                </p>


                            </div>
                            <div class="col-md-6 story-info">
                                <h5> 02. Add To Cart</h5>
                                <p>Lorem illum facere aperiam sequi optio consectetur adipisicing elitFuga, suscipit totam animi consequatur.
                                </p>
                            </div>
                            <div class="col-md-6 story-info">
    ...
    <section class="w3l-services-6" style="margin-top: 30px;">
        <!-- /content-6-section -->
    ...
    <section class="features-4">
        <div class="features4-block py-5">
            <div class="container py-lg-5">
                ...
                <h3 class="hny-title text-center">Lo que nos  <span>ofrece</span></h3>

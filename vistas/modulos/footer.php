		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> 970729692

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> romajeans@gmail.com.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> Real Nª458
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d8509.53850818488!2d-75.21534458635416!3d-12.068235931888394!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2spe!4v1611424500019!5m2!1ses-419!2spe" width="100%" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>	
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; <?php echo date('Y'); ?> Todos los derechos reservados. Sitio elaborado por la Compañía</h5>

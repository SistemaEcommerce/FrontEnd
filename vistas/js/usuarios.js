...
/* capturar el boton de perfil de foto */
...
function validarComentario() {
    ...
    if (comentario != "") {
        ...
        if (!expresion.test(comentario)) {
            ...
            $("#comentario").parent().before('<div class="alert alert-danger"><strong style="color:#000">ERROR:</strong> No se permiten caracteres especiales como por ejemplo !$%&/?¡¿[]*</div>');
